...
![](https://csdnimg.cn/release/blogv2/dist/pc/img/original.png)[《王道》数据结构笔记整理2022_2022版王道数据结构pdf-CSDN博客](https://blog.csdn.net/qq_44867340/article/details/119455799)

[胖胖的懒羊羊](https://xuyuanzhi051.blog.csdn.net "胖胖的懒羊羊") ![](https://csdnimg.cn/release/blogv2/dist/pc/img/newUpTime2.png) 已于 2024-03-10 14:34:07 修改

![](https://csdnimg.cn/release/blogv2/dist/pc/img/articleReadEyes2.png) 阅读量10w+ ![](https://csdnimg.cn/release/blogv2/dist/pc/img/tobarCollect2.png) ![](https://csdnimg.cn/release/blogv2/dist/pc/img/tobarCollectionActive2.png) 收藏 1.5w

![](https://csdnimg.cn/release/blogv2/dist/pc/img/newHeart2023Active.png) ![](https://csdnimg.cn/release/blogv2/dist/pc/img/newHeart2023Black.png) 点赞数 1.9k

分类专栏： [数据结构](https://blog.csdn.net/qq_44867340/category_9411135.html) 文章标签： [c语言](https://so.csdn.net/so/search/s.do?q=c%E8%AF%AD%E8%A8%80&t=all&o=vip&s=&l=&f=&viparticle=) [排序算法](https://so.csdn.net/so/search/s.do?q=%E6%8E%92%E5%BA%8F%E7%AE%97%E6%B3%95&t=all&o=vip&s=&l=&f=&viparticle=) [算法](https://so.csdn.net/so/search/s.do?q=%E7%AE%97%E6%B3%95&t=all&o=vip&s=&l=&f=&viparticle=)

于 2021-08-21 20:51:16 首次发布

版权声明：本文为博主原创文章，遵循 [CC 4.0 BY-SA](http://creativecommons.org/licenses/by-sa/4.0/) 版权协议，转载请附上原文出处链接和本声明。

本文链接：[https://blog.csdn.net/qq\_44867340/article/details/119455799](https://blog.csdn.net/qq_44867340/article/details/119455799)

版权

 [![](https://img-blog.csdnimg.cn/20210112122503662.jpg?x-oss-process=image/resize,m_fixed,h_224,w_224) 数据结构 专栏收录该内容](https://blog.csdn.net/qq_44867340/category_9411135.html "数据结构")
...
**1.数据**：数据是信息的载体，是描述客观事物属性的数、字符以及所有能输入到[计算机](https://so.csdn.net/so/search?q=%E8%AE%A1%E7%AE%97%E6%9C%BA&spm=1001.2101.3001.7020)中并被程序识别和处理的符号的集合。

**2.数据元素**：[数据元素](https://so.csdn.net/so/search?q=%E6%95%B0%E6%8D%AE%E5%85%83%E7%B4%A0&spm=1001.2101.3001.7020)是数据的基本单位，通常作为一个整体进行考虑和处理。一个数据元素可由若干数据项组成，数据项是构成数据元素的不可分割的最小单位。例如，学生记录就是一个数据元素，它由学号、姓名、性别等数据项组成。

**3.数据对象**:[数据对象](https://so.csdn.net/so/search?q=%E6%95%B0%E6%8D%AE%E5%AF%B9%E8%B1%A1&spm=1001.2101.3001.7020)是具有相同性值的数据元素的集合，是数据的一个子集。
...
**4.指定结点的前插操作**  
思想：设待插入结点是_s，将_s插入到_p的前面。我们仍然可以将_s插入到\*p的后面。然后将p->data与s->data交换，这样既能满足了逻辑关系，又能是的时间复杂度为O(1).（真是妙的不达鸟）
...
![](https://img-blog.csdnimg.cn/769f8fd9559142a0af60be9ef54a5069.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQ0ODY3MzQw,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/c2c6d87a29f8447584e13a1af1a539b1.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_18,color_FFFFFF,t_70,g_se,x_16)
...
![](https://img-blog.csdnimg.cn/aff9d8fddecc446f9563fcfba448dd2c.png)
...
在一个n阶方阵A中，若元素满足下述性值：![](https://img-blog.csdnimg.cn/c61d1300038640499d795e38a847e253.png)  
则称A为对称矩阵。  
...
3.  三对角矩阵(方阵)  
    ![](https://img-blog.csdnimg.cn/4ac20db9d84e48ff8ee59d77f8071ca9.png)  
    对角矩阵可按行优先顺序或对角线的顺序，将其压缩存储到一维数组中，且也能找到每个非零元素和向量下标的对应关系。
    
4.  稀疏矩阵  
    设在m_n的矩阵中有t个非零元素，令c=t/(m_n),当c<=0.05时称为稀疏矩阵。  
...
*   链式存储——十字链表法  
    ...
    十字链表中结点的结构示意图：  
    ![](https://img-blog.csdnimg.cn/9e166bfbd4e6449594015e0d5cd4ecd2.png)  
...
*   对于任何模式串，当第2个字符不匹配时，应尝试匹配模式串的第一个字符，因此，next\[2\] = 0;  
    例：对于串 T = `'abaabc'`  
    ![](https://img-blog.csdnimg.cn/8f037d73938c4de48b8a444d0763a485.png)
...
注意下标都是从1开始的  
传送门：[https://blog.csdn.net/m0\_37482190/article/details/86667059](https://blog.csdn.net/m0_37482190/article/details/86667059)
...
5\. ![](https://img-blog.csdnimg.cn/09f0467e7e4e45769ff143db1de2e86d.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![](https://img-blog.csdnimg.cn/bd72317904c04219a74bb4080ff31ff3.png)
...
4.  哈杜曼编码（重点）：  
    ![](https://img-blog.csdnimg.cn/b8cae9fe42fc469da95218919cffbf31.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![](https://img-blog.csdnimg.cn/171e52959a654ce9b88f0e4227dd0907.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_19,color_FFFFFF,t_70,g_se,x_16)  
![](https://img-blog.csdnimg.cn/f59c9c730b994b2fa81b3375fbca0ee1.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_20,color_FFFFFF,t_70,g_se,x_16)

##### 6.2.2 邻接表（类似于数的孩子链表表示法）

![](https://img-blog.csdnimg.cn/d98bcf8dc9c643e9b5b877f875a7c4b6.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_18,color_FFFFFF,t_70,g_se,x_16)  
![](https://img-blog.csdnimg.cn/bb3ccd33bfa642e7a73916fe8aca9f6b.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_20,color_FFFFFF,t_70,g_se,x_16)

##### 6.2.3十字链表

![](https://img-blog.csdnimg.cn/de4638dbeb7c47d8ae160138ac1dd37a.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_18,color_FFFFFF,t_70,g_se,x_16)
...
普里姆（Prim）算法。  
![](https://img-blog.csdnimg.cn/b52be7149b474d3eaf5b426c1a88878e.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_17,color_FFFFFF,t_70,g_se,x_16)

#### 6.5最短路径

迪杰斯特拉：

![](https://img-blog.csdnimg.cn/4686ea5eb1eb4d84b8aaefe6cf2ef6e2.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_18,color_FFFFFF,t_70,g_se,x_16)
...
*   查找是否成功：根据给定的值，在查找表中确定一个其关键字等于给定值的元素，如果表中存在这样元素，则称查找成功，否则，不成功。  
    折半查找：  
    ![](https://img-blog.csdnimg.cn/f48516d6aee645b2ab5cbc3664c63883.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_18,color_FFFFFF,t_70,g_se,x_16)  
    索引查找：  
    ![](https://img-blog.csdnimg.cn/a476babd78dd4e648f56043a50cca459.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5rGg6bG85LmL5q6D,size_19,color_FFFFFF,t_70,g_se,x_16)
